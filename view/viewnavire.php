  ...
  <section class="container py-5">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="createModalLabel">Ajout d'un nouveau Navire</h5>
          ...
          <div class="modal-body">
            <form action="" method="post" id="formOrder">
              <div class="form-floating mb-3">
                ...
                <label for="Nombateau">Nom du Navire</label>
              </div>
              <div class="form-floating mb-3">
    ...
    <div class="row">
      <div class="col-lg8 col-sm mb-5 mx-auto">
        <h1 class="fs-4 text-center lead text-prymary">Navires</h1>
      </div>
    </div>
    <div class="dropdown-divider"> </div>
    <div class="row">
      <div class="col-md-6">
        <h5 class="fw-bold mb-8">Liste des Navires</h5>
      </div>
      <div class="col-md-6">
    ...
    <div class="modal fade" id="UpdateModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="UpdateModalLabel">Modifier Navires</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <form action="" method="post" id="UpdateformOrder">
              ...
              <div class="form-floating mb-3">
                ...
                <label for="UpdateNombateau">Nom du Navire</label>
              </div>
              <div class="form-floating mb-3">
